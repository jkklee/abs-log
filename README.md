...
1. Aggregate statistics for "all requests" or "specified uri/request_uri" at the granularity of "minutes/minutes/hours/days".  
2. Aggregate statistics for "specified IP" by "minute/minute/hour/day" granularity.
...
The `-g` parameter specifies the polymerization of granularity (ten_min/minute/hour/day)  
